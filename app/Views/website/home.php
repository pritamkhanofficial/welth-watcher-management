...
<body>
    ...
    <div class="slider-block01">
                      ...
                      ?>
                        <div class="col-12 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="service-item hover-box-shadow bora-8 p-32 bg-white border-line-1px">
                                <a class="service-item-main flex-column gap-16" href="javascript:void(0);" onclick='showDesc("core_need_desc_id_<?=$placehover?>")'>
                                <input type="hidden" id="core_need_desc_id_<?=$placehover?>" value="<?=strip_tags($row->description)?>"/>    
        ...
        <!-- Modal -->
            <div class="modal fade" id="coreNeed" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-body" id="coreNeedBody">
                    ...
                </div>
