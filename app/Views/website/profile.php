      ...
      <div class="form-contact style-two"> 
        <div class="container mt-60 mb-32"> 
          <div class="row flex">
            <div class="col-12 col-lg-6">
              <div class="infor flex-columns-between hover-box-shadow bora-8 pt-32 pb-32 pl-28 pr-28 bg-white">
                ...
                <div class="list-more-infor">
                  <div class="item flex-item-center gap-12"><i class="ph-fill ph-check-circle text-white bg-on-surface p-8 bora-50"></i>
                    <div class="line-y"> </div>
                    <div class="heading7">Full Name :</div>
                    <br>
                    <div class="line-y"> </div>
                    <div class="body2">Protik Dawn</div>
                  </div>
                  <div class="item flex-item-center gap-12 mt-20"><i class="ph-bold ph-user text-white bg-on-surface p-8 bora-50"></i>
                    <div class="line-y"> </div>
                    <div class="heading7">Username :</div>
                    <div class="line-y"> </div>
                    <div class="body2">64663474464</div>
                  </div>
                  <div class="item flex-item-center gap-12 mt-20"><i class="ph-bold ph-phone text-white bg-on-surface p-8 bora-50"></i>
                    <div class="line-y"> </div>
                    <div class="heading7">Mobile :</div>
                    <div class="line-y"> </div>
                    <div class="body2">8655541236</div>
                  </div>
                  <div class="item flex-item-center gap-12 mt-20"><i class="ph-bold ph-envelope-simple text-white bg-on-surface p-8 bora-50"></i>
                    ...
                    <div class="line-y"> </div>
                    <div class="body2">protikdawn123@gmail.com</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-12 col-lg-6">
              <div class="infor flex-columns-between hover-box-shadow bora-8 pt-32 pb-32 pl-28 pr-28 bg-white" style="margin-top: -30px">
                <div class="heading">
                  <div class="heading5 mt-12">Linked Account</div>
                  <div class="body3 mt-8">We will get back to you within 24 hours, or call us everyday</div>
                </div>
                <div class="list-more-infor">
                  <div class="item flex-item-center gap-12 mt-20"><i class="ph-bold ph-envelope-simple text-white bg-on-surface p-8 bora-50"></i>
                    <div class="line-y"> </div>
